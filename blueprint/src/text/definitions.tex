...
\begin{definition}\label{def:MeanLambda}\uses{def:InvariantDistribution}\lean{MRTSequence}\leanok
...
\begin{definition}\label{def:MeanResponseTime}\uses{def:MeanLambda}\lean{MeanResponseTimePolicy}\leanok
...
\begin{definition}\label{def:SchedulePolicy}\uses{def:Policy, def:SpeedUpFunction, def:RateMatrix}\lean{SchedulePolicy}\notready
